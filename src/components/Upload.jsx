  ...
  return (
    ...
    >
      <img
        ...
        className={
          files.length === 0
            ? "w-96 rounded-4xl -rotate-5 translate-y-10 hidden lg:flex shadow-lg transition hover:scale-105 duration-300"
            : "hidden"
        }
        alt=""
      />
        ...
        {files.length === 0 ? (
          ...
          >
            <div className="flex flex-col items-center text-center justify-center h-full gap-5">
              ...
              {isDragActive ? (
                <p className="text-sm font-base">Drop the files here ...</p>
              ) : (
          ...
          <div className="flex items-center justify-center py-5">
            {files.map((file) => (
              <img
                ...
                alt={file.name}
                className="w-full object-cover rounded-lg border-1 border-violet-400"
              />
            ))}
          </div>
        )}
